...
所有模板统一设计语言：**标题左侧 4px 竖线装饰** + **引用块右侧圆角 `0 8px 8px 0`** + **代码块 8px 圆角 + 顶部 3px 彩色边线**。

### 极简黑白灰（当前 default.json）
- 正文：15px / 两端对齐 / 行高1.6 / 字间距0.5px / 段后距24px / 两端缩进8px
- 色调：纯黑白灰，无彩色
- 标题：H2 左侧黑色竖线 `4px solid #333333`，H3 无装饰
- 代码块/引用块：浅灰背景 `#f5f5f5` + 圆角 8px
...
### 清新绿色（fresh-green.json）
- 标题：绿色左侧竖线 `#27ae60`
- 引用块：浅绿底 `#f0faf4` + 绿色竖线
- 强调：浅绿底 `#e8f8ee`

### 商务灰（business-gray.json）
- 标题：灰色左侧竖线 `#7f8c8d`
- 整体中性灰色调，无彩色
- 强调：浅灰底 `#eef1f5`

### 紫色创意（purple-creative.json）
- 标题：紫色左侧竖线 `#8e44ad`
- 引用块：浅紫底 `#f9f2fc` + 紫色竖线
- 强调：浅紫底 `#f3e8f9`

### 报刊 editorial（newspaper.json）
- 衬线字体 Georgia / Noto Serif SC
- 标题：黑色左侧竖线 `#000000`
- 段落首行缩进 2em
- 图片/代码块/引用块无圆角（方正严肃风格）
- 强调：浅灰底 `#f0f0f0`
